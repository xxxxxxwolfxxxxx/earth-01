...
export const SKILL_REGISTRY: SkillMeta[] = [
  ...
  { id: 'currency',      path: 'daten',      pattern: /(\/kurs|wechselkurs|wie\s*viel\s+(?:sind\s+)?\d+\s+\w+\s+in)/i },
  { id: 'countries',     path: 'daten',      pattern: /(\/land\s|info zu\s+\w|hauptstadt von\s+\w)/i },
  ...
  { id: 'reminder',      path: 'automation', pattern: /(\/erinner|in\s+\d+\s+(min|minute|minuten|stunde|stunden|std|h)\b)/i },
  { id: 'pomodoro',      path: 'automation', pattern: /(\/pomodoro|^pomodoro)/i },
  { id: 'joke_quote',    path: 'spielerei',  pattern: /(\/witz|\/joke|\/zitat|^witz|^zitat)/i },
  { id: 'ask_memory',    path: 'llm',        pattern: /(?:^|\s)(?:\/frag(?:\s|$)|frag\s+\S)/i, requires_keys: ['llm_api_key','huggingface_key'] },
  { id: 'quota_check',   path: 'spielerei',  pattern: /(?:\/quota|\/limits|^quota$|^limits$|wie viel\s+(?:token|quota))/i },
  { id: 'image_gen',     path: 'spielerei',  pattern: /(?:\/bild(?:\s|$)|\/image(?:\s|$)|mal mir\s|bild von\s|bild:\s*\S)/i, requires_keys: ['huggingface_key'] },
  { id: 'voice_out',     path: 'spielerei',  pattern: /(?:\/sage(?:\s|$)|\/voice(?:\s|$)|sag(?:'s)?\s+\S|sprich\s+\S)/i, requires_keys: ['elevenlabs_key'] },
  { id: 'mail_send',     path: 'automation', pattern: /(?:\/mail(?:\s|$)|mail an\s+\S)/i, requires_keys: ['resend_api_key'] },
  ...
  { id: 'rss',           path: 'daten',      pattern: /(?:^|\s)\/(?:rss|feeds|unfeed)(?:\s|$)/i },
  { id: 'dice',          path: 'spielerei',  pattern: /(?:^|\s)\/(?:würfel|wuerfel|münze|muenze|werfen)(?:\s|$)/i },
  { id: 'qr_code',       path: 'spielerei',  pattern: /(?:^|\s)\/qr(?:\s|$)/i },
  { id: 'hash_tools',    path: 'sicherheit', pattern: /(?:^|\s)\/(?:hash|uuid)(?:\s|$)/i },
  { id: 'password_gen',  path: 'sicherheit', pattern: /(?:^|\s)\/(?:passwort|password)(?:\s|$)/i },
];
