...
export default function Login() {
  const { user, signInWithProvider, signInWithEmail, signUpWithEmail } = useAuth()
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="font-display text-3xl font-bold text-white text-center mb-8">
        ...
        <form onSubmit={handleEmailSubmit} className="space-y-4">
          <input
            ...
            required
            className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-nebula-500/50"
          />
          <input
            type="password"
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-nebula-500 to-blue-600 text-white rounded-xl font-display font-semibold hover:shadow-lg hover:shadow-nebula-500/25 transition-all"
          >
