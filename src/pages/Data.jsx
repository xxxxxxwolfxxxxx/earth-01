...
// Phase 3-Spendensystem entfernt — die Job-Wirtschaft läuft seit Phase 4
// komplett auf dem Bot-Profil. Hier nur noch ein Verweis dorthin.
function DonateSection() {
  return (
    <section className="mb-8 p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5">
      <h2 className="font-display text-white text-lg font-bold flex items-center gap-2 mb-2">
        🤝 Bot-Arbeit & Schwarm
      </h2>
      <p className="text-gray-400 text-sm mb-4">
        Deinen Bot zur Schwarm-Arbeit schicken, dein API-Tagesbudget einteilen,
        Credits sammeln und Projekte beauftragen — das findest du jetzt gebündelt
        im Bot-Profil.
      </p>
      <Link
        to="/bot"
        className="inline-flex items-center gap-1.5 px-4 py-2 bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-100 rounded-lg border border-emerald-500/30 text-sm no-underline transition"
      >
        Zum Bot-Profil →
      </Link>
    </section>
